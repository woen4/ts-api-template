...
export type StorageHash =
  StorageHashBase<'310ed5fd2ee0d74380e2e2f6e40578e5d52b674ba70fc663fca9f26773e07706'>;
export type ExecutionHash =
  ExecutionHashBase<'e142b02d630e8c6e0fa90d9fa6ff248a0376840641d33038aa8bb3be5ad4cbf1'>;
        ...
        readonly entries: {
          readonly table: {
            readonly posts: {
              ...
              indexes: readonly [
                {
                  readonly name: 'posts_userId_idx_a489d58a';
                  readonly prefix: 'posts_userId_idx';
